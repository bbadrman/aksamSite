(function ($) {
    ...
    jQuery(document).on('ready', function () {
        ...
        $('#ancienne').on('change', function (e) {
            var optionSelected = $("option:selected", this);
            var valueSelected = this.value;
            if (this.value == "Non") {
                $("#motif1").hide();
                $("#motif").val('pas de motif');
            } else {
                $("#motif1").show();
                $("#motif").val('');
            }
...
//     $("#activite").select2({
//         placeholder: "Veuillez renseigner votre activité"
//     });

//     $("#motif").select2({
//         placeholder: "Veuillez renseigner le motif de résiliation"
//     });
// })
